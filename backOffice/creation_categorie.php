            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar2">
                    <ul class="nav navbar-nav" id="menu">
                        ...
                        <li class="active"><a href="creation_categorie.php"><span class="glyphicon glyphicon-list-alt"></span>Nouvelle catégorie</a></li>
                        <li><a href="modifier_categorie.php"><span class="glyphicon glyphicon-inbox"></span> Modifier une catégorie</a></li>
                        <li><a href="gerer_categorie"><span class="glyphicon glyphicon-inbox"></span> Gèrer une catégorie</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <form method="Post" action="enregistrer_categorie.php">
                ...
                <div class="form-group row">
                    ...
                    for ($i = 0; $i < $rows; $i++) {
                        ...
                        echo ( "<td> <input class='form-check-input' type='checkbox' value='' name='mnemonique' >
